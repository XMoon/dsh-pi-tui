...
> `@earendil-works/pi-tui` v0.85.1 (see `UPSTREAM.json` for the pinned
...
**Controls:**
- Mouse wheel: Scroll the visible window in alternate-screen mode
- Click: Select a row (hover/move never changes the selection)
- Arrow keys: Navigate
- Enter: Select
- Escape: Cancel
...
**Controls:**
- Mouse wheel: Scroll the visible window in alternate-screen mode
- Click: Activate a row (hover/move never changes the selection)
- Arrow keys: Navigate
