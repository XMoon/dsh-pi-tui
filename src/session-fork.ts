 ...
 * workspace cwd, the source's base provider/model options, and `parentSession`
 * + `isSeeded` + `inheritedEventCount` metadata (the exact chain `/fork`
 * used before the extraction). The effective Session model selection, when
