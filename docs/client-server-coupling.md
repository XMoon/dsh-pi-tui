...
| `src/subagent-viewer-submit.ts` | (structural `ctx.subagents` followup surface, injected) | Already a dependency-injected seam — the M1 Cut 1 template (`SubagentPort`). |
